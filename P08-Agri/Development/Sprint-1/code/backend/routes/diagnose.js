...
// Gets ML service URL from environment variables
...
// Returns user-friendly error message based on HTTP status
...
// Handles image diagnosis request from authenticated user
