...
// Extracts real client IP from request headers (handles proxies)
...
// Checks if user has exceeded help request rate limit
...
// Submits help/complaint request with rate limiting
